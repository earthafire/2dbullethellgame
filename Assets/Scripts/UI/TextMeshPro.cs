...
[SerializeField] public TMP_Text _playerLevelTMP, _currentExperienceTMP, _timerTMP, _healthValueTMP;
    ...
    void FixedUpdate()
    {
        ...
        _healthValueTMP.SetText(_playerAttributes._localAttributes[Attribute.health].ToString() + "/" + _playerAttributes._playerAttributes.GetAttribute(Attribute.health).ToString());
    }
}
